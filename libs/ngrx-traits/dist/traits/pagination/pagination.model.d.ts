...
export interface EntityAndPaginationState<T>
  extends EntityAndStatusState<T>,
    PaginationState {}
export declare type PaginationActions = {
  loadPage: ActionCreator<
    string,
    (props: { index: number; forceLoad?: boolean }) => {
      index: number;
      forceLoad?: boolean;
    } & TypedAction<string>
  >;
...
export declare type PaginationSelectors<T> = {
  isPageInCache: (
...
export declare type PaginationMutators<T> = {
...
export declare const paginationTraitKey = 'pagination';
