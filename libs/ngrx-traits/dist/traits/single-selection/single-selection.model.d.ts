...
export declare type SingleSelectionActions = {
...
export declare type SingleSelectionSelectors<T> = {
  selectIdSelected: (
...
export declare type SingleSelectionMutators<T> = {
...
export declare const singleSelectionTraitKey = 'singleSelection';
export declare type SingleSelectionKeyedConfig = KeyedConfig<
