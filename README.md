...
The most important ones you will see there is the fetch actions, they are meant to be used to create an effect that will populate the state, this actions are also use by other entities related traits like filter, sort, pagination, to fetch data when needed. Let's do one for our product list:
...
Now we have simple product list loaded, to keep this intro brief I don't intent to show much of the internals of the presentational components we use, but you will be able to see them in the examples' folder, they are just regular angular code using angular material.
