...
```typescript
sortEntities: (options?: { sort: Sort<Entity> | CdkSort<Entity>; skipLoadingCall?: boolean }) => void;
```

If collection provided, the following methods are generated, example: **products**
